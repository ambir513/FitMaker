...
function About() {
  ...
  return (
    <div>
      ...
      <div className="bg-neutral-900 py-6 sm:py-8 lg:py-12">
  <div className="mx-auto max-w-screen-xl px-4 md:px-8">
   
    <div className="mb-10 md:mb-16">
      <h2 className="mb-4 text-center text-2xl font-bold text-white md:mb-6 lg:text-3xl">Meet our Trainers</h2>

      <p className="mx-auto max-w-screen-md text-center text-slate-400 md:text-lg">This is a section of some simple filler text, also known as placeholder text. It shares some characteristics of a real written text but is random or otherwise generated.</p>
    </div>
   

    <div className="grid grid-cols-2 gap-x-4 gap-y-5 md:grid-cols-3 lg:gap-x-8 lg:gap-y-5">
      
      <div>
        <div className="mb-2 h-48 overflow-hidden rounded-lg bg-gray-100 shadow-lg sm:mb-4 sm:h-60 md:h-80">
          <img src="https://images.pexels.com/photos/2204196/pexels-photo-2204196.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" loading="lazy" alt="Photo by Radu Florin" className="h-full w-full object-cover object-center" />
        </div>

        <div>
          <div className="font-bold text-orange-500 md:text-lg">John McCulling</div>
        </div>
      </div>
      ...
      <div>
        <div className="mb-2 h-48 overflow-hidden rounded-lg bg-gray-100 shadow-lg sm:mb-4 sm:h-60 md:h-80">
          <img src="https://images.pexels.com/photos/29526383/pexels-photo-29526383/free-photo-of-man-lifting-dumbbells-on-an-incline-bench-in-gym.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" loading="lazy" alt="Photo by christian ferrer" className="h-full w-full object-cover object-center" />
        </div>

        <div>
          <div className="font-bold text-orange-500 md:text-lg">Kate Berg</div>
      ...
      <div>
        <div className="mb-2 h-48 overflow-hidden rounded-lg bg-gray-100 shadow-lg sm:mb-4 sm:h-60 md:h-80">
          <img src="https://images.pexels.com/photos/18060231/pexels-photo-18060231/free-photo-of-man-in-tank-top-at-gym.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load" loading="lazy" alt="Photo by Ayo Ogunseinde" className="h-full w-full object-cover object-center" />
        </div>

        <div>
          <div className="font-bold text-orange-500 md:text-lg">Greg Jackson</div>
      ...
      <div>
        <div className="mb-2 h-48 overflow-hidden rounded-lg bg-gray-100 shadow-lg sm:mb-4 sm:h-60 md:h-80">
          <img src="https://images.pexels.com/photos/1431283/pexels-photo-1431283.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" loading="lazy" alt="Photo by Midas Hofstra" className="h-full w-full object-cover object-center" />
        </div>

        <div>
          <div className="font-bold text-orange-500 md:text-lg">Robert Greyson</div>
      ...
      <div>
        <div className="mb-2 h-48 overflow-hidden rounded-lg bg-gray-100 shadow-lg sm:mb-4 sm:h-60 md:h-80">
          <img src="https://images.pexels.com/photos/14406016/pexels-photo-14406016.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load" loading="lazy" alt="Photo by Elizeu Dias" className="h-full w-full object-cover object-center" />
        </div>

        <div>
          <div className="font-bold text-orange-500 md:text-lg">John Roberts</div>
      ...
      <div>
        <div className="mb-2 h-48 overflow-hidden rounded-lg bg-gray-100 shadow-lg sm:mb-4 sm:h-60 md:h-80">
          <img src="https://images.pexels.com/photos/5327508/pexels-photo-5327508.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" loading="lazy" alt="Photo by Matheus Ferrero" className="h-full w-full object-cover object-center" />
        </div>

        <div>
          <div className="font-bold text-orange-500 md:text-lg">Judy Amandez</div>
    ...
    <div className="max-w-[85rem] px-4 py-12 sm:px-6 lg:px-8 lg:py-16 mx-auto">
      ...
      <div aria-hidden="true" className="flex -z-[1] absolute start-0">
        <div className="bg-neutral-900   w-[1036px] h-[300px] "></div>
      </div>
      ...
      <div className="lg:grid lg:grid-cols-6 lg:gap-8 lg:items-center">
        <div className="hidden lg:block lg:col-span-2">
          <img className="rounded-xl" src="https://images.unsplash.com/photo-1671726203390-cdc4354ee2eb?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=560&q=80" alt="Avatar"></img>
        </div>
        ...
        <div className="lg:col-span-4">
          ...
          <blockquote>
            ...
            <p className="text-xl font-medium text-slate-400 lg:text-2xl lg:leading-normal dark:text-neutral-200">
...
<footer className="mt-6">
  <div className="flex items-center">
    <div className="lg:hidden shrink-0">
      <img className="size-12 rounded-full" src="https://images.unsplash.com/photo-1628253747716-0c00eeefeb37?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=2&w=320&h=320&q=80" alt="Avatar" />
    </div>
    <div className="ms-4 lg:ms-0">
      <p className="font-medium text-slate-300 dark:text-neutral-200">
        Arjun Sharma
      </p>
      <p className="text-sm text-slate-300 dark:text-neutral-400">
        Fitness Enthusiast
      </p>
                </div>
              </div>
  ...
  <div className="bg-gradient-to-r from-orange-500 via-orange-400 to-orange-500 py-20 px-6 relative font-[sans-serif]">
